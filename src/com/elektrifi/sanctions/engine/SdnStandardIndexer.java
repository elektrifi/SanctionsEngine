 ...
 */
public class SdnStandardIndexer {

    private static IndexWriter 			writer;

    // Set up log4j logger
	private static Logger logger = Logger.getLogger(SdnStandardIndexer.class);
    ...
    public static void main(String[] args) throws IOException, SAXException
    {
		...
		String indexDir = config.getProperty("SdnStandardIndexDirectory");
